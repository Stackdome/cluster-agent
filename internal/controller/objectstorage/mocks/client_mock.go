...
//
//	mockgen -package=mocks -destination=internal/controller/objectstorage/mocks/client_mock.go sigs.k8s.io/controller-runtime/pkg/client Client,StatusClient
//
