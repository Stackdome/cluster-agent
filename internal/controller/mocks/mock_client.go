...
// Source: sigs.k8s.io/controller-runtime/pkg/client (interfaces: Client,StatusClient,SubResourceWriter)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=internal/controller/mocks/mock_client.go sigs.k8s.io/controller-runtime/pkg/client Client,StatusClient,SubResourceWriter
//
