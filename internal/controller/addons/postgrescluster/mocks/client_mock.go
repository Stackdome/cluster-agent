...
// Source: sigs.k8s.io/controller-runtime/pkg/client (interfaces: Client,StatusClient)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=internal/controller/addons/postgrescluster/mocks/client_mock.go sigs.k8s.io/controller-runtime/pkg/client Client,StatusClient
//
